...
function QBCore.Player.CheckPlayerData(source, PlayerData)
    ...
    if GetResourceState('ox_inventory') ~= 'missing' then
        PlayerData.items = exports.ox_inventory:Inventory(PlayerData.source)
    end
...
function QBCore.Player.Save(source)
    ...
    if PlayerData then
        ...
        if GetResourceState('ox_inventory') ~= 'missing' then exports.ox_inventory:SaveInventory(source) end
...
function QBCore.Player.SaveOffline(PlayerData)
    if PlayerData then
        ...
        if GetResourceState('ox_inventory') ~= 'missing' then exports.ox_inventory:SaveInventory(PlayerData, true) end
...
function QBCore.Player.GetTotalWeight(items)
    if GetResourceState('ox_inventory') == 'missing' then return end
    return exports.ox_inventory:GetTotalWeight(items)
end

function QBCore.Player.GetSlotsByItem(items, itemName)
    if GetResourceState('ox_inventory') == 'missing' then return end
    return exports.ox_inventory:GetSlotsByItem(items, itemName)
end

function QBCore.Player.GetFirstSlotByItem(items, itemName)
    if GetResourceState('ox_inventory') == 'missing' then return end
    return exports.ox_inventory:GetFirstSlotByItem(items, itemName)
end
